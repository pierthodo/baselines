...
def main():
    ...
    LOG_DIR = args.path+str(args.identifier)+"lr_"+str(extra_args['lr'])+"_beta_" +str(extra_args['beta'])+"_theta_"+ str(extra_args['theta']) + "_decay_" + str(extra_args['decay']) +"_noise_"+str(extra_args['noise_reward']) +"/" + str(args.env) + "/" + str(args.seed) + "/"
